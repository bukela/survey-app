...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('login')); ?>" method="post">
                ...
                <div class="input__block">
                    <div class="text-wrapper">
                        ...
                        <span>
                                    <a href="<?php echo e(route('password.request')); ?>">Wachtwoord vergeten?</a>
                                </span>
                    </div>
            ...
            <h4 class="centered">Heeft u nog geen account? <a href="<?php echo e(route('register')); ?>">Registreren</a></h4>
        </div>
    </div>
</div>
