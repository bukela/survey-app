...
@section('content')
    <div class="top__buttons">
        <div class="button-left">
            <a href="{{ route('manager.home') }}" class="button button__purple button-left"><span>&lt; terug</span></a>
        </div>
        ...
        <div class="row">
            ...
            <div class="heading__block heading__block-smaller col-md-7">
                ...
                <div class="trophy__block">
                    <span>afgerond {{ $doctor->patients()->count() }}/10</span>
        ...
        @foreach($doctor->patients as $key => $patient)
            <div class="row table__row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="col-md-6 col-md-offset-0 col-sm-4 col-sm-offset-4 col-xs-11 col-xs-offset-1 enquete__text">
                        @if ($survey2 = \App\SurveyDoctorPatient::where(['survey_id' => 2, 'doctor_id' => $doctor->id, 'patient_id' => $patient->id])->first())
                            <img src="{{ asset('img/correct.svg') }}" alt="">
