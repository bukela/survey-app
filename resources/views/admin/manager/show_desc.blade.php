    ...
    <div class="container">
        <div class="row">
            ...
            <div class="sorting row">
                    <div class="col-md-8">
                    <!-- <p><a href="/admin/managers/{{ $manager->slug }}">Sorteren op naam</a>
                    <i class="fa fa-sort-up"></i>
                    </p> -->
                    <p>
                        Sorteren op naam: <a href="/admin/managers/{{ $manager->slug }}"><button class="sorter-button" style="line-height: 23px;color: #424040"><i class="fas fa-sort-alpha-up"></i></button></a>
                    </p>
                    </div> 
                    <div class="col-md-4">
        ...
        <div class="main-div">
        @foreach($manager->doctors->sortByDesc('name') as $doctor)
